/*
  Subworkflow that runs PyProphet scoring and inference on aligned OSW data:
  score -> peptide -> protein -> export.

  Expectation:
    - aligned_osw: path to aligned merged.osw file (from ARYCAL)
...
workflow PYPROPHET_OSW_FULL {

  take:
    aligned_osw  // Aligned merged.osw from ARYCAL
